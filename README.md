...
> `chatgpt.com/backend-api/wham/usage`의 구독 한도 응답을 읽습니다. OpenAI API 키, API 토큰 사용량,
...
- **격리된 Codex 로그인**: ChatGPT 로그인·사용량 성공 확인·쿠키 캡처는 전용 프로세스에서 수행하고, 반환 쿠키는 앱 본체에서 다시 검증한 뒤 DPAPI로 저장합니다. 로그인 페이지가 멈춰도 트레이·설정·위젯은 계속 동작합니다.
